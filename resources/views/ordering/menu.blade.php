...
<form method="POST" action="/{{$customer_id}}/{{$menu->id}}/add">
  @csrf
            ...
            <div class="flex-fill rounded p-3 d-none d-md-block" style="background-color: #000">
              <div class="d-flex flex-column gap-3 flex-lg-row justify-content-between align-items-center">
                ...
                <div class="btn-group" role="group" aria-label="Quantity">
                  ...
                  <input type="text" id="quantityDesktop" name="quantity" class="btn btn-light" x-model="quantity"
                ...
                {{-- Add menu to cart --}}
                <button name="submitDesktop" type="submit" class="btn btn-success">
    ...
    <footer class="footer px-1 py-3 sticky-bottom d-md-none" style="background-color: #000">
      <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group" role="group" aria-label="Quantity">
          ...
          <input type="text" id="quantityMobile" name="quantity" class="btn btn-light disabled" x-model="quantity"
            style="width: 3rem" />
        ...
        {{-- Add menu to cart --}}
        <button name="submitMobile" type="submit" class="btn btn-success">
          Add&nbsp;&nbsp;<i class="fas fa-cart-plus mr-2"></i>
        </button>
      </div>
    </footer>
