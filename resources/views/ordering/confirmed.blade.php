<x-customer-layout>
  ...
  <main class="bg-dark vh-100 p-5">
    <div class="d-flex flex-column gap-5 align-items-center position-absolute top-50 start-50 translate-middle">
      ...
      <div class="text-white d-flex flex-column flex-md-row align-items-center text-center gap-2 ">
        <div>
          <div class="px-5 pb-3">
        ...
        <div class="d-flex flex-column gap-2 rounded p-4 text-dark" style="background-color: #F7E7D8; width: 18rem">
          <div>
            <h3>Estimated Preparation Time:</h3>
            <p class="fs-5">{{$estimatedTime}} mins</p>
          </div>
          <div>
            <h3>Total Price:</h3>
